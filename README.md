...
My name is John. I am a **digital creator**, a self-employed **full-stack developer**, a **cinematographer**, and most importantly, a full-time **high school student**. My primary areas of interest are **iOS/macOS** (Swift), **Android** (Java, Kotlin), and **Web** (React/React Native, Tailwind CSS, NextJS, Flask, Django, Node.js, Electron, MongoDB, PostgreSQL, Firebase, Docker, Ubuntu Server, etc.)
