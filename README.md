...
My name is John. I am a **digital creator**, a self-employed **software engineer**, a **cinematographer**, and most importantly, a full-time **high school student**. My primary areas of interest are **iOS/macOS** (Swift), **Android** (Java, Kotlin), and **Web** (React/React Native, Node.js, NextJS, Flask, Django, Electron, MongoDB, Firebase, Docker, Ubuntu Server, etc.)
